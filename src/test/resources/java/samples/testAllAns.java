...
/**
 * A class to provide a simple list. List resizes automatically. Used to illustrate various design
 * and implementation details of a class in Java.
 *
 * @author scottm
 */
public class GenericListVersion2 implements Iterable {
    ...
    /**
     * Default add method. Add x to the end of this IntList. Size of the list goes up by 1.
     *
    ...
    private void ensureCapcity() {
        ...
        // if not, resize
        if (iSize == iValues.length) resize();
    }
    ...
    /**
     * Constructor to allow user of class to specify initial capacity in case they intend to add a
     * lot of elements to new list. Creates an empty list.
     *
     * @param initialCap > 0
     */
     ...
     * @return true if other is a non null, IntList object that is the same size as this IntList and
     *     has the same elements in the same order, false otherwise.
     */
